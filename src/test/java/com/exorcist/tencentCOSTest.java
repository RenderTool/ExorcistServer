...
//        String key = "publish/LatestGame/abc.txt"; //游戏本体完整安装包
//        String key = "publish/LatestLauncher/abc.txt";//游戏启动器安装包
        String key = "publish/patch/abc.txt";//游戏补丁路径
        String localPath = "D:\\UE5PJ2\\GameServer\\ExorcistServer\\src\\test\\java\\com\\exorcist\\abc\\abc.txt";
